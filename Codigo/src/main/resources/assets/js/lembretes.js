...
function readReminder(id) {
    fetch(`https://ti2-organizai.azurewebsites.net/lembretes/${id}`, {
        method: 'GET',
        headers: { 'Content-Type': 'application/json' }
    })
    .then(res => res.json())
...
function updateReminder(id, reminder) {
    ...
    fetch('https://ti2-organizai.azurewebsites.net/lembretes/update', {
    method: 'PUT', 
    headers: {
...
function deleteReminder(id) {
    fetch(`https://ti2-organizai.azurewebsites.net/lembretes/delete/${id}`, {
        method: 'GET'
    })
    .catch(error => {
        console.error(error)
